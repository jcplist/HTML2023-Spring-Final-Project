...
regr = BaggingRegressor(estimator=SVR(cache_size=4096), n_estimators=10, random_state=0).fit(train_x, train_y)
...
def Eval (i):
    ...
    vregr = BaggingRegressor(estimator=SVR(cache_size=1024), n_estimators=10, random_state=0).fit(vxtr, vytr)
