...
regr = HistGradientBoostingRegressor(random_state=0, loss='absolute_error', categorical_features=[8], l2_regularization=10).fit(train_x, train_y)
...
def Eval (i):
    ...
    vregr = HistGradientBoostingRegressor(random_state=0, loss='absolute_error', categorical_features=[8], l2_regularization=10).fit(vxtr, vytr)
...
'''
Ein: 1.4334609227461803
Eval: 1.607067774482387 (0)
Eval: 1.61415985871049 (1)
Eval: 1.6168357267301976 (2)
Eval: 1.5916325527611055 (3)
Eval: 1.6341141323324622 (4)
'''
