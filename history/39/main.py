...
discrete_features = ["Duration_ms", "Views", "Likes", "Comments"]
...
model = Pipeline(steps=[
    ...
    # ('regressor', HistGradientBoostingRegressor(loss='absolute_error', l2_regularization=1000, random_state=lucky_cucumber, verbose=verbose))
])
